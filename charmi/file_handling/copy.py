...
# shutil.copy(source_file1, destination_file1)       #this has already  been copied

destination_file2 = 'files/data2.txt'  
destination_file3 = 'files/data2/'
try:
    # shutil.copystat(source_file1, destination_file2)    #this shows the time when the file was copied
