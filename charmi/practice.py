...
def selecting_positions():

    #asking user the letter they want.
    userinput= input("Please choose a letter X or O. : ")
    selection = print("you  chose letter : " , userinput) 

    #getting user positions.
    userinput2 = input("Please select your position.: ")

    #getting  an answer from the computer.
    computer = randint(0,len(avail))
    computers_num = avail.pop(computer)

def getting_the_winner():
    '''
    combinations: 
    (1, 2, 3, 4) 
    (5, 6, 7, 8) 
